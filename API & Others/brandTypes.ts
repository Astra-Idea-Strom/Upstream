 ...
 * Shared between React (Frontend) and Node.js/Express (Backend)
 */
...
/**
 * Request payload sent from React Step 3/4 to Express Backend
 */
...
/**
 * Result payload containing stitched prompts ready for OpenAI DALL-E 3 or Flux
 */
export interface GeneratedPromptPayload {
  ...
  /** Clean prompt formatted specifically for OpenAI DALL-E 3 API prompt field */
  dalle3Prompt: string;
...
/**
 * Frontend UI Card Metadata (For React Step 3: Visual Direction)
 */

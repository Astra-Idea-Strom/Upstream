/**
 * Archetype UI Card Definitions (React Frontend - Step 3: Visual Direction)
 * 
 * Provides metadata, human-readable descriptions, industry recommendations,
 * and reference brand exemplars to render interactive selection cards in the React multi-step form.
 */

import { ArchetypeUICard, LogoArchetype } from './brandTypes';
